...
from App.apis.common.item_info_api import ItemInfoResource, ItemNumberResource, ItemTypeNumberResource
...
common_api.add_resource(ItemTypeNumberResource, '/iteminfo/data/')
